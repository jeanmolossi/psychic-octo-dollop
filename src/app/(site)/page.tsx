        ...
        <>
            <section className="overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col gap-4 md:justify-center md:items-center">
                <TitleSection
                    ...
                    title="All-In-One Collaboration and Productivity plaform"
                />

                <div className="bg-white p-[2px] mt-6 rounded-xl bg-gradient-to-r from-primary to-brand-primaryBlue sm:w-[300px]">
                    <Button variant="btn-secondary" className="w-full rounded-[10px] p-6 text-2xl bg-background">Get Cypress Free</Button>
                </div>
                ...
                <div className="md:mt-[-90px] sm:w-full w-[750px] flex justify-center items-center mt-[-40px] relative sm:ml-0 ml-[-50px]">
                    ...
                    <div className="bottom-0 top-1/2 bg-gradient-to-t dark:from-background absolute inset-x-0 z-10"></div>
                </div>
            </section>
            ...
            <section className="relative">
                ...
                >
                    <TitleSection
                        ...
                        subheading="Join thousands of satisfied users personal and professional productivity needs."
                        pill="Testimonials"
                    />
                        ...
                        <div
                            ...
                            className={twMerge(
                                clsx('mt-10 flex flex-nowrap gap-6 self-start', {
                                    'flex-row-reverse ml-[100vw]': index === 1,
